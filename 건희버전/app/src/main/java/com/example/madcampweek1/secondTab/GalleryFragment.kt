...
import com.example.madcampweek1.GalleryDatabaseActivity
import com.example.madcampweek1.R
import com.example.madcampweek1.firstTab.PhoneAdapter
...
//        view.gallery_recycler_view.adapter = adapter
        ...
        view.option_dbG.setOnClickListener{
            if(AccessToken.getCurrentAccessToken()!=null){
                val intent = Intent(context, GalleryDatabaseActivity::class.java)
